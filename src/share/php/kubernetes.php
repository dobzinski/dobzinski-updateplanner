...
if ($permission == 'W') {
    ...
    htmlText('v-kubernetes', 'Name', $data['kubernetes'], 10, '', 'Enter a kubernetes name, you can add multiple kubernetes <i>(by CNCF)</i>.');
...
htmlTable('t-kubernetes', array('t_kubernetes'=>'Kubernetes', 't_active'=>'Act'), 'id', $result, array('1', 'asc'), ($permission == 'W' ? array('edit', 'delete') : array()), array('t_active'));
htmlAccordion('close');
htmlAccordion('end');
htmlForm('end');